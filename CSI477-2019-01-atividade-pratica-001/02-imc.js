function calcular() {
	...
	var val1 = validarTexto(document.IMC.Nome,"alertaNome");
	var val2 = validarNumero(document.IMC.Peso,"alertaPeso");
	var val3 = validarNumero(document.IMC.Altura,"alertaAltura");
